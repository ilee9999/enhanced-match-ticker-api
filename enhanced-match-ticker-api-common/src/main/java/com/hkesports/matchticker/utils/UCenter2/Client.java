...
public class Client extends PHPFunctions{
	...
	public static String UC_API = "http://guide-uat.hkesports.com/forum/uc_server";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "123456";
	public static String UC_APPID = "12";
...
//		}
	 ...
	 */
	public String userCheckName(String name){
		Map<String, Object> args = new HashMap<String, Object>();
	 ...
	 */
	public String userCheckEmail(String email){
		Map<String, Object> args = new HashMap<String, Object>();
		args.put("email", email);
		return call_user_func(UC_API_FUNC, "user", "check_email", args);
	}
}
